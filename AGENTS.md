...
Sentinel is an educational, portfolio-quality security monitoring platform. It is a Next.js frontend plus a modular FastAPI backend using PostgreSQL.
...
- The simulator may create synthetic telemetry only and may target only configured Sentinel development endpoints. Never add scanning, exploitation, credential attacks, malware, persistence, or destructive behavior.
