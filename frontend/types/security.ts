...
export interface SecurityEvent { id:string; timestamp:string; event_type:string; source:string; outcome:string|null; user_identifier:string|null; source_ip:string|null; endpoint:string|null; status_code:number|null; simulated:boolean; metadata:Record<string,unknown>; anomaly_score:number|null; is_anomaly:boolean|null; anomaly_model_version:string|null; }
